			...
			<div className="footer__inner">
				<div className="footer-col">
					<p>
						...
						<ExtLink 
						classes="btn btn--text btn--text-footer" 
				...
				<div className="footer-col">
					...
					<div>
						...
						{/* Facebook */}
						<ExtLink url="https://facebook.com/">
						...
						{/* Instagram */}
						<ExtLink url="https://instagram.com/">
						...
						{/* LinkedIn */}
						<ExtLink url="https://linkedin.com/">
